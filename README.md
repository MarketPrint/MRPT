...
RESERVE              0.006987054355506147 ETH
...
```
FINALIZED PRINTS     1
LAST VERIFIED BLOCK  25997771
ENGINE STATUS        SYNCED
```

Token [`0xe3004E6b1782120D434DA18b7C6575a06Cd0a607`](https://etherscan.io/address/0xe3004E6b1782120D434DA18b7C6575a06Cd0a607) · block [25997771](https://etherscan.io/block/25997771)

[Current](live/current.json) · [Latest](live/latest.json) · [Status](live/status.json) · [All PRINTs](prints/)

*Read from finalized Ethereum state through public RPC. Updated 2026-09-17T14:39:27.895Z.*
